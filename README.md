...
# belly • [![tests](https://github.com/abigger87/belly/actions/workflows/tests.yml/badge.svg)](https://github.com/abigger87/belly/actions/workflows/tests.yml) [![lints](https://github.com/abigger87/belly/actions/workflows/lints.yml/badge.svg)](https://github.com/abigger87/belly/actions/workflows/lints.yml) ![GitHub](https://img.shields.io/github/license/abigger87/belly)  ![GitHub package.json version](https://img.shields.io/github/package-json/v/abigger87/belly)
...
Click `use this template` on [Github](https://github.com/abigger87/belly) to create a new repository with this repo as the initial state.

Run `make rename` to rename all instances of `belly` with the name of your project/repository.
...
[AGPL-3.0-only](https://github.com/abigger87/belly/blob/master/LICENSE)
